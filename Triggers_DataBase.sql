...
AS
BEGIN
IF EXISTS(SELECT 1 FROM inserted AS I INNER JOIN Empleados AS E ON I.Telefono=E.Telefono AND  I.IdEmpleado <> E.IdEmpleado)
BEGIN
...
AS
BEGIN
IF EXISTS(SELECT 1 FROM inserted AS I INNER JOIN EMPLEADOS AS E ON I.Email=E.Email AND I.IdEmpleado <> E.IdEmpleado)
BEGIN
...
AS
BEGIN
IF EXISTS(SELECT 1 FROM inserted AS I WHERE I.IdTipoRol!=1)
BEGIN
